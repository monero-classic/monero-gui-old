...
UninstallDisplayIcon={app}\monero-classic-wallet-gui.exe
...
Source: "bin\monero-classic-wallet-gui.exe"; DestDir: "{app}"; Flags: comparetimestamp
...
Source: "monero-classic-wallet-gui.log"; DestDir: "{app}"; Flags: comparetimestamp; Permissions: users-modify

; Monero Classic CLI wallet
Source: "bin\monero-classic-wallet-cli.exe"; DestDir: "{app}"; Flags: comparetimestamp

; Monero Classic wallet RPC interface implementation
Source: "bin\monero-classic-wallet-rpc.exe"; DestDir: "{app}"; Flags: comparetimestamp
...
; Filename: "{app}\monero-classic-wallet-gui.exe"; Description: "Run GUI Wallet now"; Flags: postinstall nowait skipifsilent
...
begin
  ...
  blockChainDefaultDir := ExpandConstant('{commonappdata}\moneroclassic');
...
begin
  Result := BlockChainDir('') + '\moneroclassic.log';
...
Name: "{group}\GUI Wallet"; Filename: "{app}\monero-classic-wallet-gui.exe"
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\monero-classic-wallet-cli.exe"; WorkingDir: "{userdocs}\Monero\wallets"
...
Name: "{group}\Utilities\x (Check GUI Wallet Log)"; Filename: "Notepad"; Parameters: "{app}\monero-classic-wallet-gui.log"
...
Name: "{userdesktop}\GUI Wallet"; Filename: "{app}\monero-classic-wallet-gui.exe"; Tasks: desktopicon
